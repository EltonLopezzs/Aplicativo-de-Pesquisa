...
def tela_inicial():
    ...
    coluna1 = [
        [sg.Text('LOGRADOURO', font='arial 12', pad=(4, 2))],
        [sg.Text('BAIRRO', font='arial 12', pad=(4, 2))],
        [sg.Text('LOCALIDADE', font='arial 12', pad=(4, 2))],
        [sg.Text('UNIDADE FEDERATIVA', font='arial 12', pad=(4, 2))],
        [sg.Text('IBGE', font='arial 12', pad=(4, 2))],
        [sg.Text('DDD', font='arial 12', pad=(4, 2))]
    ]
    ...
    layout = [
        [sg.Text('Consulta CEP é DDD', font='arial 20 bold')],
        [sg.Text('Vamos Consultar!', font='arial 14', pad=(0, 0))],
        [sg.Text('Faça Consulta de CEP E DDD de Todo o BRASIL', font='arial 14', pad=(0, 0))],
        ...
        [sg.Text('Github @EltonLopezzs', pad=(0, (35, 0)))]
